...
return {
	...
	PoliceArmoury = {
		...
		blip = {
			...
			vector3(454.32, -999.34, 35.06)
		}, targets = {
			{ loc = vector3(454.32, -999.34, 35.06), length = 0.5, width = 3.0, heading = 270.0, minZ = 30.5, maxZ = 32.0, distance = 6 }
		}
	},
	...
	VendingMachineDrinks = {
		...
		model = {
			`prop_vend_soda_02`, `prop_vend_fridge01`, `prop_vend_water_01`, `prop_vend_soda_01`, `prop_vend_soda`
		}
	}
}
